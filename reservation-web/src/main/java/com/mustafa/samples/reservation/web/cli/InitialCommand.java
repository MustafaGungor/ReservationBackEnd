package com.mustafa.samples.reservation.web.cli;
...
import com.mebitech.robe.security.db.domain.Role;
...
import com.mebitech.robe.security.db.repository.RobeRoleRepository;
...
public class InitialCommand {
    ...
    @Autowired
    private RobeRoleRepository robeRoleRepository;
